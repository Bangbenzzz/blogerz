  ...
  return (
    <div className="min-h-screen bg-[var(--bg-main)] flex flex-col items-center justify-center p-4 text-center">
      ...
      <p className="text-[var(--text-muted)] max-w-md mb-8 leading-relaxed">
        Akun Anda telah diblokir oleh Administrator karena melanggar aturan komunitas. Jika ini sebuah kesalahan,
      ...
      <div className="mt-6">
        <Link href="/" className="text-xs text-[var(--text-muted)] hover:text-[#3B82F6]">
          Kembali ke Home
        </Link>
      </div>
    </div>
